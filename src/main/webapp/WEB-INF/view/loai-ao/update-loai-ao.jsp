...
<div class="col-8 offset-2">
    <h1 style="text-align: center">Update loại áo</h1>
    <br>
    <form:form method="post" action="/loai-ao/update" modelAttribute="loaiAo">
        <div class="col-6">
...
<script>
    function check(){
        return confirm("Bạn có muốn sửa ${loaiAo.ten} không ?")
    }
</script>
</body>
</html>