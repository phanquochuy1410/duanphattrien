...
<div class="col-8 offset-2">
    <h1 style="text-align: center">Update chất liệu</h1>
    <br>
    <form:form method="post" action="/chat-lieu/update" modelAttribute="chatLieu">
        <div class="col-6">
...
<script>
    function check(){
        return confirm("Bạn có muốn sửa ${chatLieu.ten} không ?")
    }
</script>
</body>
</html>