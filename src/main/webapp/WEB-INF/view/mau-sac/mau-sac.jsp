...
<div class="col-8 offset-2">
    ...
    <div>
        <a href="/mau-sac/hien-thi?page=0">
            <button class="btn btn-success"> |<</button>
        </a>
        <c:if test="${soTrang > 0}">
            <a href="/mau-sac/hien-thi?page=${soTrang - 1}">
                <button class="btn btn-success"> <<</button>
            </a>
        </c:if>
        ...
        <a href="/mau-sac/hien-thi?page=${cuoiTrang - 1}">
            <button class="btn btn-success"> >|</button>
        </a>
    </div>
</div>
<script>
    function check(){
        return confirm("Bạn có muốn thêm ${mau-sac.ten} không ?")
    }
</script>
</body>
</html>