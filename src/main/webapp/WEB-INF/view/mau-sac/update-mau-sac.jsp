...
<div class="col-8 offset-2">
    <h1 style="text-align: center">Update màu sắc</h1>
    <br>
    <form:form method="post" action="/mau-sac/update" modelAttribute="mauSac">
        <div class="col-6">
...
<script>
    function check(){
        return confirm("Bạn có muốn sửa ${ms.ten} không ?")
    }
</script>
</body>
</html>